...
export const components: ComponentDoc[] = [
  ...
  { slug: "glass", title: "Glass", description: "Liquid Glass: the light-bending control-layer material, regular and clear.", swiftui: "glassEffect(_:in:)" },
  { slug: "glass-button", title: "Glass Button", description: "Liquid Glass capsule button with springy press and optional tint.", swiftui: ".buttonStyle(.glass)" },
  { slug: "glass-tab-bar", title: "Glass Tab Bar", description: "Floating glass capsule with a pill morphing between tabs.", swiftui: "TabView (iOS 26)" },
